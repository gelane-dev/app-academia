...
@router.get("/perfil", response_model=UsuarioResposta)
...
@router.get("/perfil/professor", response_model=ProfessorResposta)
...
@router.get("/perfil/aluno", response_model=AlunoResposta)
